...
def args():
	...
	parser.add_argument('--test_clean_speech', default=False, type=str2bool, help='Test on clean speech')
	parser.add_argument('--test_noisy_speech', default=False, type=str2bool, help='Test on noisy speech')
